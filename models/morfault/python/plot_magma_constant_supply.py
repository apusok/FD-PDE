...
pl0 = ax.plot(A0.t_kyr,(A0.Vphi-A0.Vphi[0])/A0.Vphi[0],label=r'$b$ = '+lbl[0])
pl1 = ax.plot(A1.t_kyr,(A1.Vphi-A1.Vphi[0])/A1.Vphi[0],label=r'$b$ = '+lbl[1])
pl2 = ax.plot(A2.t_kyr,(A2.Vphi-A2.Vphi[0])/A2.Vphi[0],label=r'$b$ = '+lbl[2])
plt.grid(True)
