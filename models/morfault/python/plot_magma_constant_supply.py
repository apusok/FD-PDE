...
sims = ['run43_01a_SD_setup6_Kphi1e-7_sigmabc1e-2_dtvf/',
        ...
        'run43_01a_SD_setup6_Kphi1e-7_sigmabc1e-2_iterPVphi_dt5/']
...
pl0 = ax.plot(A0.t_kyr[0:indx[0][0]],y0[0:indx[0][0]],'k-',label=r'fromm')
...
pl0 = ax.plot(A0.t_kyr[0:indx[0][0]],A0.phi_max[0:indx[0][0]],'k-',label=r'fromm')
...
pl0 = ax.plot(A0.t_kyr[0:indx[0][0]],A0.z_max[0:indx[0][0]],'k-',label=r'fromm')
