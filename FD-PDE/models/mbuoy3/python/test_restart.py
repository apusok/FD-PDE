# Test restart feature in the MORBuoyancy3 model

import os

# Model options
model_opts = ' -L 200.0e3 -H 100.0e3 -zmin -100e3 -output_file out_model'+ \
             ' -nx 40 -nz 20 -U0 4 -K0 1e-7 -eta0 1e18 -zeta0 1e19 -Tp 1648'+ \
             ' -tstep 10 -tout 1 -tmax 1e6 -dtmax 1e2 -ts_scheme 2 '+ \
             ' -xsill 6e3 -extract_mech 0 -buoyancy 0 -visc_shear 0 -visc_bulk 0 '+ \
             ' -visc_bulk1 1 -phi_min 1e-6 -phi_init 0.0 '
...
# Non-dimensional
str1 = '../MORbuoyancy3.app '+model_opts+solver_opts+' > log_out_nd_orig.out'
print('nd_orig')
os.system(str1)
str1 = '../MORbuoyancy3.app '+model_opts+solver_opts+' -restart 1 > log_out_nd_r1.out'
print('nd_r1')
os.system(str1)
str1 = '../MORbuoyancy3.app '+model_opts+solver_opts+' -restart 5 > log_out_nd_r5.out'
print('nd_r5')
os.system(str1)
