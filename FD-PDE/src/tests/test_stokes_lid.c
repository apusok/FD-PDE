...
// Lid-driven cavity flow benchmark - constant grid spacing
// run: ./tests/test_stokes_lid.app -pc_type lu -pc_factor_mat_solver_type umfpack -nx 10 -nz 10
// python test: NO
// ---------------------------------------
static char help[] = "Application to solve the lid-driven cavity flow benchmark with FD-PDE \n\n";
