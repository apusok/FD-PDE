...
static PetscErrorCode Liquidus(FDPDE fd, DM dm, Vec x, DM dmphase, Vec xCF, void *ctx) { return 0; }
static PetscErrorCode Solidus(FDPDE fd, DM dm, Vec x, DM dmphase, Vec xCS, void *ctx) { return 0; }
