...
PetscErrorCode SNESStokes_MOR(DM *_dm, Vec *_x, void *ctx)
{
  ...
  ierr = DMStagViewBinaryPython_SEQ(dmPV,x,"numerical_solution_mor.vtr");CHKERRQ(ierr);
...
// Get dm coordinates array
  ...
  ierr = DMStagViewBinaryPython_SEQ(dm,x,"analytic_solution_mor.vtr");CHKERRQ(ierr);
