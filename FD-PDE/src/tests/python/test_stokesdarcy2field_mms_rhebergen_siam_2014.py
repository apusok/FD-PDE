...
alpha = 1.0 # [-1.0/3.0, 0, 1, 1e1, 1e3, 1e6]
...
for nx in n:
  ...
  str1 = '../test_stokesdarcy2field_rhebergen-siam-2014.app -pc_type lu -pc_factor_mat_solver_type umfpack -alpha '+str(alpha)+' -nx '+str(nx)+' -nz '+str(nx)+' > '+fout1
  print(str1)
  os.system(str1)
