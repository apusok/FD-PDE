...
# mass plot
ax3 = axs[1,1]
pl30 = ax3.plot(dt,massan,color='gray',label='analytical')
pl31 = ax3.plot(dt,mass00,color='r',label='forward Euler')
pl32 = ax3.plot(dt,mass01,color='b',label='backward Euler')
pl33 = ax3.plot(dt,mass02,color='k',label='Crank-Nicholson')
ax3.set_xlabel('Time steps')
ax3.set_ylabel('Int(Q)')
# ax3.set_title('Integrated quantity')
