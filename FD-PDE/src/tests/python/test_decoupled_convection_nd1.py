...
# Run test
str1 = '../test_decoupled_convection_nd1.app -pc_type lu -pc_factor_mat_solver_type umfpack -ts_flg '+str(ts_flg)+' -dt '+str(dt)+' -adv_scheme '+str(adv_scheme)+' -ts_scheme '+str(ts_scheme)+' -output_file '+fname+' -tstep '+str(tstep)+' -tout '+str(tout)+' -nx '+str(n)+' -nz '+str(n)+' > '+fname+'.out'
print(str1)
os.system(str1)
