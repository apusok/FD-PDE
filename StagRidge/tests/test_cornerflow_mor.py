...
for nx in n:
    ...
    fout1 = f1[:-5]+'_rangle0_'+str(nx)+'.out'
    fout2 = f1[:-5]+'_rangle30_'+str(nx)+'.out'
    ...
    str2 = '../src/stagridge -options_file '+f1+' -rangle 30 -nx '+str(nx)+' -nz '+str(nx)+' > '+fout2
    print(str2)
    os.system(str2)
...
fname = 'test_mor_convergence.pdf'
plt.savefig(fname)
