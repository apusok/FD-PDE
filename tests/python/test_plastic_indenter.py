...
# Run simulation
str1 = '../test_plastic_indenter_ -pc_type lu -pc_factor_mat_solver_type umfpack -pc_factor_mat_ordering_type external -snes_monitor_true_residual -ksp_monitor_true_residual -snes_converged_reason -ksp_converged_reason'+ \
    ' -output_file '+fname+ \
    ' -g '+str(g)+ \
    ' -eta0 '+str(eta0)+ \
    ' -C '+str(C)+ \
