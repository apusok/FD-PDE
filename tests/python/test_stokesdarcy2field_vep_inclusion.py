...
# ---------------------------------------
print('# --------------------------------------- #')
print('# StokesDarcy-VEP, inclusion test ')
print('# --------------------------------------- #')
...
# filenames 
fname = 'out_stokesdarcy2field_vep_inclusion'
...
# Run simulation
str1 = 'mpiexec -n '+str(ncpu)+' ../test_stokesdarcy2field_vep_inclusion.app' + newton + solver + sdpar + \
  ' -output_file '+fname+ \
  ' -C_b '+str(cb)+ \
  ' -lam_p '+str(lam_p)+ \
  ' -ew_v0 '+str(ew)+ \
