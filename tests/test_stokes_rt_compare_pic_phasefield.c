// ---------------------------------------
// run: ./test_stokes_rt_compare_pic_phasefield_ -pc_type lu -pc_factor_mat_solver_type umfpack -pc_factor_mat_ordering_type external -nx 21 -nz 21 -snes_type ksponly -snes_fd_color -nt 101 -log_view
